...
point_t* PreferenceLearning(point_set *original_set, point_set *realSet, point_t *u, int k, std::ofstream &fp)
{
    int M, testCount = 0, correctCount = 0;
    ...
    while (accuracy < 0.99999 && numOfQuestion < 50)
    {
        numOfQuestion++;
        ...
        //int option = realSet->show_to_user(p->id, q->id);
